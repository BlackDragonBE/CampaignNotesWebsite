...
const config = require('../campaign.config');
...
function generateLeafletMapHtml(relativePath, resolveObsidianLink) {
    ...
    const dataPath = path.join(config.sourceDirectory, config.leafletDataPath || '_data/LeafletMaps/plugins/obsidian-leaflet-plugin/data.json');
